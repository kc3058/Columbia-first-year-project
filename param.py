        ...
        for line in fp:
            ...
            if pline != [] and len(pline) > 1:
                intList = ["V_CELLS", 
                           ...
                           'RETIRE_FLAG',
                           'CUST_SCHEDULE',
                           'CLOUD_INJECTION_MODE',
                           'CLOUD_MIN_INJECTION_STEP']
                floatList = ["V_MU", 
                             "V_SIGMA", 
                             "M_MU", 
                             "M_SIGMA", 
...
#        self.paramDict['R_START'] = self.paramDict['R_START'] * const.pc
        ...
        self.paramDict['CLOUD_INJECTION_START'] *= const.pc
        self.paramDict['CLOUD_INJECTION_END'] *= const.pc
        self.paramDict['CLOUD_MIN_INJECTION_STEP'] *= const.pc
